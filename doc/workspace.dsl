workspace {
    ...
    model {
        ...
        enterprise CFP {
            ...
            cfpSystem = softwareSystem "Controle Financeiro Pessoal" "A melhor forma de manter o controle dos gastos e planejar o futuro" {
                ...
                web_app = container "Aplicação Web" "Produz o conteúdo estático da aplicação (SPA) de controle financeiro pessoal." "NodeJS + Express + Angular"
    ...
    views {
        ...
        systemContext cfpSystem "C4-Level1" "C4 - Level 1" { include * }
        container cfpSystem "C4-Level2" "C4 - Level 2" { include * }
        component api_cpf "C4-Level3" "C4 - Level 3" { include * }
